...
class EmployeeSALE extends StatefulWidget {
  const EmployeeSALE({key}) : super(key: key);

  @override
  _EmployeeSALEState createState() => _EmployeeSALEState();
}

class _EmployeeSALEState extends State<EmployeeSALE> {
