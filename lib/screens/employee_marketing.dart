...
class EmployeeMARKETING extends StatefulWidget {
  const EmployeeMARKETING({key}) : super(key: key);

  @override
  _EmployeeMARKETINGState createState() => _EmployeeMARKETINGState();
}

class _EmployeeMARKETINGState extends State<EmployeeMARKETING> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Nhân viên MARKETING'),
        centerTitle: true,
      ),
      body: ListView(
