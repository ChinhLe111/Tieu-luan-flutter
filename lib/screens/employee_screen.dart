...
import 'package:mobx_emp_manager/screens/employee_it.dart';
import 'package:mobx_emp_manager/screens/employee_marketing.dart';
import 'package:mobx_emp_manager/screens/employee_sale.dart';
      ...
      drawer: Drawer(
        child: new ListView(
          children: <Widget>[
            ...
            new ListTile(
              title: new Text("Toàn bộ nhân viên"),
              onTap: () {
                Navigator.pop(context);
              },
            ),
            new ListTile(
              title: new Text("Nhân viên đã nghĩ hưu"),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                    context,
                    new MaterialPageRoute(
                        builder: (ctxt) => new RetiredEmployeeScreen()));
              },
            ),
            new ListTile(
              title: new Text("Nhân viên IT"),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                    context,
                    new MaterialPageRoute(
                        builder: (ctxt) => new EmployeeIT()));
              },
            ),
            new ListTile(
              title: new Text("Nhân viên SALE"),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                    context,
                    new MaterialPageRoute(
                        builder: (ctxt) => new EmployeeSALE()));
              },
            ),
            new ListTile(
              title: new Text("Nhân viên MARKETING"),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                    context,
                    new MaterialPageRoute(
                        builder: (ctxt) => new EmployeeMARKETING()));
              },
            ),
          ],
        ),
